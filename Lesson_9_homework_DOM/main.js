...
firstBlock.classList.add("wrap");
firstBlock.classList.add("collapse");
firstBlock.classList.add("alpha");
firstBlock.classList.add("beta");
firstBlock.innerText ="Testing first block inner text";
document.body.appendChild(firstBlock);
document.body.appendChild(firstBlock.cloneNode(true));
...
secondBlock.appendChild(ulBlock);
for(const arrElem of array) {
    let newLi = document.createElement("li");
    newLi.innerText = arrElem;
...
let thirdBlock = document.getElementsByClassName("thirdBlock")[0];
for (const arrEl of coursesAndDurationArray) {
    let elBlock = document.createElement("div");
    elBlock.classList.add("elementBlock");
    elBlock.innerText = "title: " + arrEl.title + ",   duration: "+ arrEl.monthDuration;
    thirdBlock.appendChild(elBlock);
}
...
let fourthBlock = document.getElementsByClassName("fourthBlock")[0];
for (const arrElement of coursesAndDurationArray) {
    let arrElBlock = document.createElement("div");
    arrElBlock.classList.add("item");
    let headingElement = document.createElement("h1");
    headingElement.classList.add("heading");
    headingElement.innerText = arrElement.title;
    arrElBlock.appendChild(headingElement);

    let descriptionElement = document.createElement("p");
    descriptionElement.classList.add("description");
    descriptionElement.innerText = arrElement.monthDuration;
    arrElBlock.appendChild(descriptionElement);

    fourthBlock.appendChild(arrElBlock);
}
...
let fifthBlock = document.getElementsByClassName("fifthBlock")[0];
for (const simpson of simpsons) {
    let simpsonBlock = document.createElement("div");
    simpsonBlock.classList.add("member");

    for (const simpsonField in simpson) {
        let elem = document.createElement("p")
        if(simpsonField === "photo" || simpsonField.length === 0) {
            continue;
        }
        elem.innerText = simpsonField + ": " + ` ${simpson[simpsonField]}`
        simpsonBlock.appendChild(elem);

    }
    let img = document.createElement("img");
    img.src = simpson.photo;
    simpsonBlock.appendChild(img);
    fifthBlock.appendChild(simpsonBlock);
}
...
let sixthBlock = document.getElementsByClassName("sixthBlock")[0];
